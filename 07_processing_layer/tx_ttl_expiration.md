...
[tx_lifecycle_management.md](tx_ttl_expiration%20md%20(1)%20250f1989022c80c0bc35da35a8324342/tx_lifecycle_management%20md%20250f1989022c8104a6e0e76347b4b875.md)
...
For the complete rollback architecture and advanced mechanics (including batching, nested isolation, tombstone registry, and deterministic replay), see:

[tx_rollback_strategy.md](notion://www.notion.so/tx_rollback_strategy.md)

This document complements the current section and should be reviewed for deeper system-wide rollback integration.
