...
## Purpose
This module manages the economic incentives and security deposits for AST validators. It enforces the "Stake-to-Validate" rule, ensuring that all participants have 'skin in the game'. It handles stake locking, payment distribution based on PoT performance, and punitive slashing.
