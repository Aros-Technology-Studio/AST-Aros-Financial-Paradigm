...
## 26. 2026-06-28 Full Re-Audit (branch: claude/inspiring-cannon-nfank4, session 20)

**Scope:** Independent re-audit of all emission modules against the canonical 1:1 model.
Session: `session_01YQWm2NZoyvJmBTbtUEyVRa` (claude-sonnet-4-6)
...
- `src/reserve/reserve.service.ts` — audited (lines 55–105)
- `src/orchestrator/orchestrator.service.ts` — audited (lines 150–189)
- `reference/ast-core/src/emission.ts` — read; 20-line canonical reference confirms identical structure
...
| reserveIndex = log10(1 + volume) | `src/reserve/reserve.service.ts` | 92–94 | CONFIRMED |
| AFC accruals recorded, not in formula | `src/reserve/reserve.service.ts` | 62, 79 | CONFIRMED |
