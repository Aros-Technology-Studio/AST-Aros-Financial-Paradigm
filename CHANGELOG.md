...
* [Contribution Types](https://www.google.com/search?q=%23contribution-types)  
* [Guidelines](https://www.google.com/search?q=%23guidelines)  
...
* [Code Style and Standards](https://www.google.com/search?q=%23code-style-and-standards)  
* [Testing and Quality Assurance](https://www.google.com/search?q=%23testing-and-quality-assurance)  
* [Legal and Compliance](https://www.google.com/search?q=%23legal-and-compliance)  
* [Community and Communication](https://www.google.com/search?q=%23community-and-communication)  
...
* **Governance Proposals:** Suggest parameter changes (e.g., emission ratios) backed by simulations from economic\_simulation.md.  
...
* **Modularity:** Place code in correct folders (e.g., py/ for Python in 07\_processing\_layer/).  
* **Inclusivity:** Follow CODE\_OF\_CONDUCT.md—harassment-free, empathetic collaboration.  
...
2. **Clone and Install:**  
   git clone \[https://github.com/aros-studio/aros-tokenomics.git\](https://github.com/aros-studio/aros-tokenomics.git)  
   cd aros-tokenomics  
...
5. **Run Locally:**  
   ...
   * **Python API:** uvicorn 07\_processing\_layer.api.app:app \--reload.  
   * **Extensions in VS Code:** Solidity, Python, Hardhat Solidity, Prettier.

For full setup, see deployment\_guide.md.

## **Pull Request Process**

As Technical Program Manager, PRs must be:

* **Descriptive:** Title with Conventional Commits, body with "What/Why/How," references to issues/docs.  
* **Small:** One feature/fix per PR (e.g., "Add TTL to TX queue").  
* **Tested:** Include tests (pytest/Hardhat), coverage reports.  
* **Linted:** Run black ., ruff ., npx prettier \--write ..  
* **Reviewed:** At least 2 approvals; check for compliance (e.g., no data leaks).  
* **Merged:** Squash commits, rebase on main.  
...
* **Simulations:** Use economic\_simulation.md for token model tests.  
...
* **Channels:** Slack/Discord for team (invite via PR), Twitter for updates (@aros\_studio).  
