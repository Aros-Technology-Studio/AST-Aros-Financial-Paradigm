...
export interface ArosCoinInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "withdrawUnlockedStakes",
    values?: undefined
  ): string;
...
export interface ArosCoin extends BaseContract {
  connect(runner?: ContractRunner | null): ArosCoin;
  waitForDeployment(): Promise<this>;

  interface: ArosCoinInterface;
  ...
  withdrawUnlockedStakes: TypedContractMethod<[], [void], "nonpayable">;
  ...
  >;
  getFunction(
    nameOrSignature: "withdrawUnlockedStakes"
