...
| **08** | **Fee Distribution Layer** | The protocol-level controller for token supply, minting new tokens based on network epochs. | `epoch_allocation_model.md` |
...
| **11** | **Security Deposit & Payments** | Manages validator staking, performance scoring (`Validator_performance_score.md`), and penalties. | `staking_overview.md` |
