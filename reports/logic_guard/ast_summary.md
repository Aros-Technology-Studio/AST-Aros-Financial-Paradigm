...
- TERM-FORBID: Forbidden term "Payment" found (tools/spec_rules.json)
...
- TERM-FORBID: Forbidden term "Payment" found (12_nodechain_ai_agents/agent_roles_matrix.md)
- TERM-FORBID: Forbidden term "reward" found (12_nodechain_ai_agents/validator_behavior_monitor.md)
- TERM-FORBID: Forbidden term "Payment" found (12_nodechain_ai_agents/validator_behavior_monitor.md)