 ...
 *
 * Node influence derives entirely from the `weight` field, which reflects confirmed
 * work (successes/total) scaled by uptime — the reputation formula. The service records
 * work completions, recomputes reputation from history, and logs payment receipts in
 * NodeChain. All influence is earned through confirmed execution (I9).
 *
