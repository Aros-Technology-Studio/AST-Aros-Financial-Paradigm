...
export class OrchestratorService {
    ...
    async runProcess(input: RunProcessDto): Promise<RunProcessResult> {
        ...
        // volume (emission.minted events); AFC commission accruals are recorded separately
        // for audit and never enter the formula (spec I-RS-1). Reading it reflects this run's
