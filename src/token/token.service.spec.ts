...
const mockEmissionService = {
    calculate: jest.fn().mockReturnValue({ emissionAmount: 100, commission: 0.5, nodeShare: 0.375, afcReserveShare: 0.125, commissionRate: 0.005 }),
    processTransactionEmission: jest.fn().mockResolvedValue({ emissionAmount: 100 }),
    contributeToAfcReserve: jest.fn(),
